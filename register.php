            ...
            <div class="col-lg-8 col-md-10 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form enctype="multipart/form-data" class="row g-3 needs-validation" method="POST" action="admin/processing/bymember.php" novalidate>
                    ...
                    <div class="col-md-6">
                      ...
                      <input accept="image/*" type="file" value="defaulprofile.png" name="profileImage" class="form-control" id="yourName">
                      <div class="invalid-feedback">Svp Entrer votre prenom!</div>
                    </div>

                    <div class="col-md-6">
                      <label for="yourEmail" class="form-label">Numero de téléphone</label>
                      <input type="text" name="numerotelephone" class="form-control" id="yourEmail" required>
                      <div class="invalid-feedback">Svp Entrer votre numéro!</div>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Svp Entrer votre nom d'utilisateur.
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-12 text-center">
                      <button name="save" class="btn btn-primary w-40 fw-bold" type="submit">Créer un
                        compte</button>
                    </div>
                    <div class="col-12 text-center">
                      <p class="small mb-0">Vous avez déjà un compte? <a href="index.php">Se
                          connecter</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                Réalisé avec amour par <a href="tel:+243993342115">Charlie Kyakimwa</a>
              </div>
