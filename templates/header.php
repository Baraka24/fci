    ...
    <ul class="d-flex align-items-center">
      <li class="nav-item dropdown pe-3">
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          <img src="../assets/img/<?php echo $_SESSION['PROFILE'] ?>" alt="Profile" class="rounded-circle" style="height: 40px; width:40px;">
          <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $_SESSION['POSTNOM'] . " " . $_SESSION['PRENOM'] ?></span>
