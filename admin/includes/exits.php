    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">Sorties récentes <span>| Today</span></h5>
            ...
            <div class="modal-body ms-3">
                <form method="POST" action="../admin/processing/addsortie.php">
                    ...
                    <div class="form-floating mb-3">
                        <input required name="description" type="text" class="form-control" id="floatingInput" placeholder="name@example.com">
                    ...
                    <div class="form-floating mb-3">
                        <input required name="montant" type="number" min="0" class="form-control" id="floatingInput" placeholder="name@example.com">
                        <label for="floatingInput">Montant</label>
                    </div>
                    <div class="form-floating mb-3">
                        <textarea required name="observation" class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 100px;"></textarea>
