                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    ?>
                                <td>
                                    <a href=" ./upentree.php?id=<?= $val['id'] ?>">
                                        <span class="badge bg-success ms-0">
                                            <i class="bi bi-pencil-square fa-lg "></i>
                                        </span>
                                    </a>
                                    <a href="../admin/processing/deleteentree.php?id=<?= $val['id'] ?>">
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header border-bottom-0 ">
                <h5 class="modal-title fw-bold" id="exampleModalLabel">Nouvelle Entrée</h5>
                <button type="button" class="btn-close h2 fw-bold" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body ms-3">
                <form method="POST" action="../admin/processing/addentree.php">
                    <div class="row mb-3">
                        <div class="col-sm-10">
