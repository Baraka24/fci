            ...
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    ...
                    foreach ($all as $key => $val) { ?>
                        ...
                        <form method="POST" action="../admin/processing/updateentree.php">
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-xxl-6">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input required value="<?= $val['description'] ?>" name="description" type="text" class="form-control" id="floatingInput" placeholder="name@example.com">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input required value="<?= $val['montant'] ?>" name="montant" type="number" min="0" class="form-control" id="floatingInput" placeholder="name@example.com">
                                        <label for="floatingInput">Montant</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <textarea required value="<?= $val['observation'] ?>" name="observation" class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 100px;"></textarea>
                                        <label for="floatingTextarea">Observation</label>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-10">
                                            <button name="update" type="submit" class="btn btn-success fw-bold">Enregistrer</button>
                                        </div>
                                    </div>
                                </div>
