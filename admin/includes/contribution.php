            ...
            <div class="modal-body ms-3">
                <form method="POST" action="../admin/processing/paiement.php">
                    <div class="form-floating mb-3">
                        <select name="membre" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                            <?php
                    ...
                    <div class="form-floating mb-3">
                        <select name="motif" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                    ...
                    <div class="form-floating mb-3">
                        <select name="devise" class="form-select" id="floatingSelect" aria-label="Floating label select example">
